...
*/
    ...
    //Testing Create, Read and Delete 
    ...
    std::vector<json> read_results = col->read(field, value);
    ...
    if (delete_count > 0) {
        cout << "Successfully deleted " << delete_count << " document" << endl;
    ...
    //READ after deletion
    std::vector<json> verify_results = col->read(field, value);
